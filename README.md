...
# ciaa-ml Framework for Embedded Systems Firmware development in C/C++ 
...
**ciaa-ml** is a makefile-based project that act as a framework for Embedded Systems firmware development in C/C++ language. It support toolchain, libraries and examples for several platforms.
